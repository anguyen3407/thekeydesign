...
class Prices extends Component {
  constructor(){
    ...
    toggleCheckbox() {
      this.setState({standard: !this.state.standard})
      this.setState({twilight: !this.state.twilight})
          ...
          <h1>Basic Staging Package</h1>
                <div className = 'includes'>
                    ...
                    <div className='add-btn-container'>
                      <button className='addToCart-btn'  type="button" onClick={()=> {this.toggleClick()}}> Add To Cart</button>
                    </div>
  </div>
  </div>
